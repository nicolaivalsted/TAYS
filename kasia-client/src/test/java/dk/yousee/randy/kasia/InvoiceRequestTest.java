...
public class InvoiceRequestTest {
    ...
    public void createRentMovieWithPrice() throws Exception {
        // without koda
        String s = InvoiceRequest.createMovieWithPrice("612345678", InvoiceRequest.SALES_ITEM_RENT_MOVIE, "title", "user", "system", "vodid", "42.00", null, null, "rent-movie").printJson().toString();
        ...
        // with koda
        s = InvoiceRequest.createMovieWithPrice("612345678", InvoiceRequest.SALES_ITEM_RENT_MOVIE, "title", "user", "system", "vodid", "42.00", "40.50", "1.50", "rent-movie").printJson().toString();
    ...
    public void createBuyMovieWithPrice() throws Exception {
        // without koda
        String s = InvoiceRequest.createMovieWithPrice("612345678", InvoiceRequest.SALES_ITEM_BUY_MOVIE, "title", "user", "system", "vodid", "42.00", null, null, "buy-movie").printJson().toString();
        ...
        // with koda
        s = InvoiceRequest.createMovieWithPrice("612345678", InvoiceRequest.SALES_ITEM_BUY_MOVIE, "title", "user", "system", "vodid", "42.00", "40.50", "1.50", "buy-movie").printJson().toString();
