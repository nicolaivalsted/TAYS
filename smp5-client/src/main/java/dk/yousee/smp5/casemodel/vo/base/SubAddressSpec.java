...
public class SubAddressSpec extends BasicUnit {
	...
	public PropHolder address1 = new PropHolder(this, Constants.ADDRESS1);

	public PropHolder address2 = new PropHolder(this, Constants.ADDRESS2);
