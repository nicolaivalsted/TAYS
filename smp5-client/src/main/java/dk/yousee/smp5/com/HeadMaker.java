...
public class HeadMaker extends XmlMaker {
	 ...
	 *            collection to add to. Precondtion: N elements, Postcomdition:
	 *            N+M elements (M={0..n})
	 * @param order
	 *            to take data from input
	 */
	 ...
	 *
	 * @param paramList
	 *            an list on input, on output this list has between 0 and N more
	 *            elements
	 * @param params
	 *            list of parameters to orderData / order
	 */
