...
/**
 * Created by IntelliJ IDEA. User: aka Date: Oct 14, 2010 Time: 5:51:20 PM<br/>
...
public class SubscriberCase extends AbstractCase {
	...
	/**
	 * USE-CASE-1: Erling: Lav et smpOrder objekt med ordre om at
	 * oprette/opdatere en kunde givet i customer
	 *
	 * @param customer
	 *            input for customer objecg Produces an order object which can
	 *            be sent to the BSS adapter to create or update the customer
	 * @param address
	 *            address input for Add Subscription
	 * @return usecase
	 */
