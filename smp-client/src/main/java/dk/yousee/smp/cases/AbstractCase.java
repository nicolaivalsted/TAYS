...
/**
 * Created by IntelliJ IDEA. User: aka Date: Oct 25, 2010 Time: 2:05:50 PM<br/>
...
public class AbstractCase {
	 ...
	 * <br/>
	 * When you update the customer (and send no order yet) and then update a plan and want both update to be in same
	 * order - then you want to keep the model. (saying true)
	 *
