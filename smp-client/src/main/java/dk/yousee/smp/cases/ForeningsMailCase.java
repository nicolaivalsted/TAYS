...
//    }
    ...
    public class ForeningsMailActivationData {
        ...
        public String toString() {
            ...
            if (getCustomerId() != null) sb.append(", customerId='").append(customerId).append('\'');
            if (getConversationDate() != null) sb.append(", conversationDate=").append(conversationDate);
            if (getConversation() != null) sb.append(", conversation=").append(conversation);
            sb.append('}');
            return sb.toString();
        }
    }
     ...
     * @param useMailAccount is the mail used by subscriber (assign true). If user dismiss then assign false.
    ...
    /**
     * Used to migrate a subscribers forenings mails.
     * It is assumed that the customer says "YES" to having the mail - otherwise he/she should not migrate ...
     *
     * @param position   that identifies forenings mail
