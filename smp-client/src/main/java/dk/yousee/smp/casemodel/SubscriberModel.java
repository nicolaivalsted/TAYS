...
/**
 * Created by IntelliJ IDEA. User: aka Date: Oct 12, 2010 Time: 12:20:19 PM This
 * model contains the data for a subscriber<br/>
 * <p>
 * This model will define all service plans, child services and their
 * attributes.
 *
 * </p>
 * <p>
 ...
 * The models objective is to keep data as consistent as possible - to ensure
 * the customers data is valid.
 * </p>
 * <p>
 * The model is a "service" it takes no action it self. It is not a client.<br/>
 * The shooting-book (drejebog in danish) is a use-case task. See
 * {@link dk.yousee.smp.cases.AbstractCase} and all its siblings. So all
 * activities - timings - when to do that and that - and what data to provide in
 * each step,<br/>
 * is a use-case level information.<br/>
 * At the same time use-cases is responsible for putting the correct values into
...
public class SubscriberModel implements Serializable {
	 ...
	 * @param acct
	 *            the account
	 * @deprecated use constructor SubscriberModel(Response response) - acct is
	 *             inside it.
	 */
